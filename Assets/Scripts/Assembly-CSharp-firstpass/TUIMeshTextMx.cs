...
public class TUIMeshTextMx : MonoBehaviour
{
	...
	public Material material_Accessor
	{
		get
		{
			return material;
	...
	public string fontName_Accessor
	{
		get
		{
			return fontName;
	...
	public float characterSpacing_Accessor
	{
		get
		{
	...
	public float lineSpacing_Accessor
	{
		get
		{
			return lineSpacing;
	...
	public HorizontalAlignment horizontalAlignment_Accessor
	{
		get
		{
	...
	public VerticalAlignment verticalAlignment_Accessor
	{
		get
		{
	...
	public void ChangeColor(int v_from, int v_to, Color v_color)
	{
		from = v_from;
		to = v_to;
		color2 = v_color;
	...
	public virtual void UpdateMesh()
	{
		...
		for (int l = 0; l < list.Count; l++)
		{
			...
			{
				array3[num6] = color2;
				array3[num6 + 1] = color2;
				array3[num6 + 2] = color2;
				array3[num6 + 3] = color2;
			}
			else
			{
				array3[num6] = color;

namespace Zombie3D
{
	public class AnimationName
	{
		...
		public const string ENEMY_RUSHINGREADY = "Ready";

		public const string ENEMY_RUSH = "Rush";
		...
		public const string ENEMY_ROAR = "Roar";
		...
		public const string FIRER_ATTACK = "Fire01";

		public const string FIRER_GOTHIT = "Damage01";

		public const string FIRER_RUN = "Forward01";

		public const string FIRER_DEAD = "Death01";

		public const string HAT_IDLE = "Idle01";

		public const string HAT_RUN = "Run01";

		public const string HAT_DEATH1 = "Death01";

		public const string HAT_DEATH2 = "Death02";

		public const string RPG_NameEnd = "_RPG";

		public const string ShotGun_NameEnd = "_Shotgun";

		public const string Saw_NameEnd = "_Saw";

		public const string SuicideGun_NameEnd = "_SuicideGun";

		public const string AirGun_NameEnd = "_AirGun";

		public const string ElectricGun_NameEnd = "_ElectricGun";
	}
}

...
namespace Zombie3D
{
	public class MultiPlayerBonusStateShield : PlayerBonusState
	{
		...
		public MultiPlayerBonusStateShield()
		{
		...
		public override void EnterState(Player player)
		{
			...
			player.PowerObj = Object.Instantiate(shieldLogo, player.GetTransform().TransformPoint(Vector3.up * 2.4f), Quaternion.identity) as GameObject;

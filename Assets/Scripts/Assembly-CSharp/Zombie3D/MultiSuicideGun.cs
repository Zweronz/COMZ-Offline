...
namespace Zombie3D
{
	internal class MultiSuicideGun : Weapon
	{
		...
		public override void ReleaseBullet()
		{
			...
			GameObject gameObject = Object.Instantiate(rConf.suicideGunBullet, rightGun.position, Quaternion.identity) as GameObject;
